...
export default function NgoProfile() {
  ...
  if (loading) return (
    <div className="min-h-screen bg-white flex flex-col">
      <Navbar />
      <div className="max-w-4xl mx-auto w-full px-6 lg:px-10 py-10 space-y-6">
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col">
      ...
      {/* ── Main content ── */}
      <div className="max-w-4xl mx-auto w-full px-6 lg:px-10 -mt-8 pb-16 flex flex-col lg:flex-row gap-8 items-start">
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-6 mb-6">
            <div className="flex items-start gap-4">
              ...
              <div className="min-w-0 flex-1">
                <h1 className="text-xl font-black text-gray-900 leading-tight mb-1">{ngo.name}</h1>
