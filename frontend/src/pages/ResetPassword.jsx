...
export default function ResetPassword() {
  ...
  const handleResend = async () => {
    ...
    try {
      ...
      setResendMsg('A new reset code has been sent to your email.');
      setCountdown(60);
      setOtp(['', '', '', '', '', '']);
    ...
    <div className="min-h-screen bg-gray-50 flex flex-col">
      ...
      <div className="flex justify-center pt-6 px-4">
        <div className="w-full max-w-sm">
          <Link to="/forgot-password" className="inline-flex items-center gap-1.5 text-sm text-gray-400 hover:text-gray-800 transition-colors">
        ...
        <div className="w-full max-w-sm">
          ...
          <div className="text-center mb-8">
            <div className="w-12 h-12 bg-orange-500 rounded-2xl flex items-center justify-center mx-auto mb-4 shadow-lg shadow-orange-100">
              <Icon name="key-round" size={22} className="text-white" />
            </div>
          ...
          <div className="bg-white rounded-2xl border border-gray-100 shadow-sm p-8">
            ...
            {success ? (
              <div className="flex flex-col items-center py-6 text-center">
                ...
                <h2 className="text-xl font-black text-gray-900 mb-1">Password reset!</h2>
                ...
                <form onSubmit={handleSubmit} className="space-y-5">
                    ...
                    <div className="flex gap-2 justify-center" onPaste={handlePaste}>
                      {otp.map((digit, i) => (
                        <input
                          ...
                          className={`w-11 h-12 text-center text-xl font-bold border rounded-xl transition-all focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent
                            ${digit ? 'border-orange-400 bg-orange-50 text-orange-600' : 'border-gray-200 text-gray-900'}`}
                        />
                      ))}
                    </div>
                  </div>
                  ...
                  <div>
                    ...
                    <div className="relative">
                      ...
                      <input
                        ...
                        className="w-full border border-gray-200 rounded-xl pl-10 pr-10 py-2.5 text-sm focus:outline-none focus:ring-2 focus:ring-orange-400 focus:border-transparent transition-shadow"
                      />
                  ...
                  <div>
                    ...
                    <div className="relative">
                      <Icon name="lock" size={14} className="absolute left-3.5 top-1/2 -translate-y-1/2 text-gray-300 pointer-events-none" />
                      <input
                        type={showPw ? 'text' : 'password'} required placeholder="Re-enter new password"
                  ...
                  >
                    {loading
                      ...
                      : <><Icon name="shield-check" size={15} />Reset Password</>
                    }
                  </button>
                </form>
          ...
          {!success && (
            <p className="text-center text-xs text-gray-400 mt-4">
              Wrong email?{' '}
              <Link to="/forgot-password" className="text-orange-500 font-semibold hover:underline">Go back</Link>
            </p>
          )}
